...
namespace Encapsulation
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("-----------------");
            Console.WriteLine(program.PrivateProtectedInProgramClass);
            ...
            //kui asub samas saab kasutada,
            //aga teises classis olevat ei saa
            //privateProtectedStudent.PrivateProtectedStudent1 = "assadsa"
