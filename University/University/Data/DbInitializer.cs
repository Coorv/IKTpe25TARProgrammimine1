    ...
    public static class DbInitializer
    {
        public static void Initialize(UniversityContext context)
        {
            ...
            var students = new Student[]
            {
                ...
                new Student{FirstMidName="Gytis",LastName="Barzukas",EnrollmentDate=DateTime.Parse("2012-09-01")},
                ...
                new Student{FirstMidName="Nini",LastName="Olivetto",EnrollmentDate=DateTime.Parse("2005-09-01")}
            };
            ...
            var courses = new Course[]
            {
                ...
                new Course{CourseId=2041,Title="Composition",Credits=3},
