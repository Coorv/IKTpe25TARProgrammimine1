    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var student = await _context.Students
                ...
                .AsNoTracking()
                //Tagastab esimese elemendi, mis on tingimuses välja toodud
            ...
            var vm = new StudentDetailsViewModel
            {
                ...
                //siis annab parem poolse väärtuse.
                EnrollmentsVm = (student.Enrollments ?? Enumerable.Empty<Enrollment>())
                    ...
                    //üks õpilane mitu kursust ära läbinud ja
                    //sellisel tulemusel peab kasutama ToArray
            };
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            //tuleb teha doimaini modelist andmete ülekanne view modeli omasse
